...
#define S_FUNCTION_NAME FORCESNLPsolver_basic_2_20_50_simulinkBlockcompact
...
typedef FORCESNLPsolver_basic_2_20_50interface_float FORCESNLPsolver_basic_2_20_50nmpc_float;

extern void FORCESNLPsolver_basic_2_20_50_casadi2forces(double *x, double *y, double *l, double *p, double *f, double *nabla_f, double *c, double *nabla_c, double *h, double *nabla_h, double *hess, solver_int32_default stage, solver_int32_default iteration);
...
static void mdlInitializeSizes(SimStruct *S)
{
	...
	/* Input Port 2 */
    ssSetInputPortMatrixDimensions(S,  2, 680, 1);
