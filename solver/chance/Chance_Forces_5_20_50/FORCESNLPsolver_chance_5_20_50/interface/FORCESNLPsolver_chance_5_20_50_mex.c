...
#include "mex.h"
#include "math.h"
#include "../include/FORCESNLPsolver_chance_5_20_50.h"
...
extern void FORCESNLPsolver_chance_5_20_50_casadi2forces(FORCESNLPsolver_chance_5_20_50_float *x, FORCESNLPsolver_chance_5_20_50_float *y, FORCESNLPsolver_chance_5_20_50_float *l, FORCESNLPsolver_chance_5_20_50_float *p, FORCESNLPsolver_chance_5_20_50_float *f, FORCESNLPsolver_chance_5_20_50_float *nabla_f, FORCESNLPsolver_chance_5_20_50_float *c, FORCESNLPsolver_chance_5_20_50_float *nabla_c, FORCESNLPsolver_chance_5_20_50_float *h, FORCESNLPsolver_chance_5_20_50_float *nabla_h, FORCESNLPsolver_chance_5_20_50_float *hess, solver_int32_default stage, solver_int32_default iteration);
FORCESNLPsolver_chance_5_20_50_extfunc pt2function_FORCESNLPsolver_chance_5_20_50 = &FORCESNLPsolver_chance_5_20_50_casadi2forces;


/* Some memory for mex-function */
FORCESNLPsolver_chance_5_20_50_params params;
FORCESNLPsolver_chance_5_20_50_output output;
FORCESNLPsolver_chance_5_20_50_info info;
...
void mexFunction( solver_int32_default nlhs, mxArray *plhs[], solver_int32_default nrhs, const mxArray *prhs[] )  
{
    ...
    if (nrhs != 1) 
	{
        mexErrMsgTxt("This function requires exactly 1 input: PARAMS struct.\nType 'help FORCESNLPsolver_chance_5_20_50_mex' for details.");
    }    
	if (nlhs > 3) 
	{
	...
	{
    mexErrMsgTxt("PARAMS.x0 must be of size [280 x 1]");
    }
#endif	 
	if ( (mxGetN(par) != 0) && (mxGetM(par) != 0) )
	{
		copyMArrayToC_double(mxGetPr(par), params.x0,280);
	...
	{
    mexErrMsgTxt("PARAMS.all_parameters must be of size [1980 x 1]");
    }
#endif	 
	if ( (mxGetN(par) != 0) && (mxGetM(par) != 0) )
	{
		copyMArrayToC_double(mxGetPr(par), params.all_parameters,1980);

	}


	#if SET_PRINTLEVEL_FORCESNLPsolver_chance_5_20_50 > 0
	...
	/* call solver */
	exitflag = FORCESNLPsolver_chance_5_20_50_solve(&params, &output, &info, fp, pt2function_FORCESNLPsolver_chance_5_20_50);
	...
	copyCArrayToM_double( output.x01, mxGetPr(outvar), 14);
	mxSetField(plhs[0], 0, "x01", outvar);

	outvar = mxCreateDoubleMatrix(14, 1, mxREAL);
	copyCArrayToM_double( output.x02, mxGetPr(outvar), 14);
	mxSetField(plhs[0], 0, "x02", outvar);

	outvar = mxCreateDoubleMatrix(14, 1, mxREAL);
	copyCArrayToM_double( output.x03, mxGetPr(outvar), 14);
	mxSetField(plhs[0], 0, "x03", outvar);

	outvar = mxCreateDoubleMatrix(14, 1, mxREAL);
	copyCArrayToM_double( output.x04, mxGetPr(outvar), 14);
	mxSetField(plhs[0], 0, "x04", outvar);

	outvar = mxCreateDoubleMatrix(14, 1, mxREAL);
	copyCArrayToM_double( output.x05, mxGetPr(outvar), 14);
	mxSetField(plhs[0], 0, "x05", outvar);

	outvar = mxCreateDoubleMatrix(14, 1, mxREAL);
	copyCArrayToM_double( output.x06, mxGetPr(outvar), 14);
	mxSetField(plhs[0], 0, "x06", outvar);

	outvar = mxCreateDoubleMatrix(14, 1, mxREAL);
	copyCArrayToM_double( output.x07, mxGetPr(outvar), 14);
	mxSetField(plhs[0], 0, "x07", outvar);

	outvar = mxCreateDoubleMatrix(14, 1, mxREAL);
	copyCArrayToM_double( output.x08, mxGetPr(outvar), 14);
	mxSetField(plhs[0], 0, "x08", outvar);

	outvar = mxCreateDoubleMatrix(14, 1, mxREAL);
	copyCArrayToM_double( output.x09, mxGetPr(outvar), 14);
	mxSetField(plhs[0], 0, "x09", outvar);

	outvar = mxCreateDoubleMatrix(14, 1, mxREAL);
	copyCArrayToM_double( output.x10, mxGetPr(outvar), 14);
	mxSetField(plhs[0], 0, "x10", outvar);

	outvar = mxCreateDoubleMatrix(14, 1, mxREAL);
	copyCArrayToM_double( output.x11, mxGetPr(outvar), 14);
	mxSetField(plhs[0], 0, "x11", outvar);

	outvar = mxCreateDoubleMatrix(14, 1, mxREAL);
	copyCArrayToM_double( output.x12, mxGetPr(outvar), 14);
	mxSetField(plhs[0], 0, "x12", outvar);

	outvar = mxCreateDoubleMatrix(14, 1, mxREAL);
	copyCArrayToM_double( output.x13, mxGetPr(outvar), 14);
	mxSetField(plhs[0], 0, "x13", outvar);

	outvar = mxCreateDoubleMatrix(14, 1, mxREAL);
	copyCArrayToM_double( output.x14, mxGetPr(outvar), 14);
	mxSetField(plhs[0], 0, "x14", outvar);

	outvar = mxCreateDoubleMatrix(14, 1, mxREAL);
	copyCArrayToM_double( output.x15, mxGetPr(outvar), 14);
	mxSetField(plhs[0], 0, "x15", outvar);

	outvar = mxCreateDoubleMatrix(14, 1, mxREAL);
	copyCArrayToM_double( output.x16, mxGetPr(outvar), 14);
	mxSetField(plhs[0], 0, "x16", outvar);

	outvar = mxCreateDoubleMatrix(14, 1, mxREAL);
	copyCArrayToM_double( output.x17, mxGetPr(outvar), 14);
	mxSetField(plhs[0], 0, "x17", outvar);

	outvar = mxCreateDoubleMatrix(14, 1, mxREAL);
	copyCArrayToM_double( output.x18, mxGetPr(outvar), 14);
	mxSetField(plhs[0], 0, "x18", outvar);

	outvar = mxCreateDoubleMatrix(14, 1, mxREAL);
	copyCArrayToM_double( output.x19, mxGetPr(outvar), 14);
	mxSetField(plhs[0], 0, "x19", outvar);

	outvar = mxCreateDoubleMatrix(14, 1, mxREAL);
	copyCArrayToM_double( output.x20, mxGetPr(outvar), 14);
